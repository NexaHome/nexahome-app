...
const styles = StyleSheet.create({
  ...
  initials: { color: "#1675D1", fontSize: 12, fontWeight: "900" },
  memberCopy: { flex: 1, paddingRight: 8 },
  memberName: { color: "#252621", fontSize: 14.5, fontWeight: "900" },
  role: { color: "#8B8E87", fontSize: 12, marginTop: 4 },
  badge: {
    minWidth: 58,
    height: 28,
    borderRadius: 6,
  ...
  badgeText: { color: "#278039", fontSize: 11, fontWeight: "900" },
  badgeDanger: { borderColor: "#FF7777", backgroundColor: "#FFF7F7" },
  badgeDangerText: { color: "#FF5C5C" },
  badgeWarn: { borderColor: "#F1BD47", backgroundColor: "#FFF7DE" },
  badgeWarnText: { color: "#B27700" },
  sectionTitle: {
    marginTop: 12,
    marginBottom: 10,
    fontSize: 18,
  ...
  permissionText: { color: "#42443E", fontSize: 14, fontWeight: "700" },
});
