...
const styles = StyleSheet.create({
  ...
  subtitle: { color: "#8B8E87", fontSize: 13, marginTop: 5, marginBottom: 16, lineHeight: 18 },
  formCard: {
  ...
  sectionTitle: { color: "#22231F", fontSize: 18, fontWeight: "900", marginTop: 18, marginBottom: 10 },
  previewCard: {
    minHeight: 78,
    backgroundColor: "#FFFFFF",
    borderWidth: 1,
  ...
  previewTitle: { color: "#252621", fontSize: 17, fontWeight: "900" },
  previewMeta: { color: "#8B8E87", fontSize: 12.5, marginTop: 5 },
  previewBadge: {
    paddingHorizontal: 12,
    paddingVertical: 7,
    borderRadius: 7,
  ...
  previewBadgeText: { color: "#278039", fontSize: 12, fontWeight: "900" },
