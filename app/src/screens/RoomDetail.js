...
const styles = StyleSheet.create({
  ...
  addBtn: { paddingHorizontal: 16, height: 40, borderRadius: 12, backgroundColor: "#FF6B00", alignItems: "center", justifyContent: "center" },
  ...
  iconBoxActive: { backgroundColor: "#FFF4ED" },
  emoji: { fontSize: 22 },
  deviceName: { fontSize: 16, fontWeight: "900", color: "#0A0F2C", marginBottom: 8 },
  statusPill: { alignSelf: "flex-start", paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8, backgroundColor: "#FFF4ED", borderWidth: 1.2, borderColor: "#FF6B00" },
  statusPillOff: { backgroundColor: "#F1F5F9", borderColor: "#CBD5E1" },
  statusText: { fontSize: 11, fontWeight: "900", color: "#B24B00", textTransform: "uppercase" },
